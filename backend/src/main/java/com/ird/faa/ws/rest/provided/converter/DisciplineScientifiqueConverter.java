...
public class DisciplineScientifiqueConverter extends AbstractConverter<DisciplineScientifique,DisciplineScientifiqueVo>{
        ...
        @Autowired
        private DisciplineScientifiqueConverter disciplineScientifiqueParentConverter ;
        @Autowired
...
public void init(Boolean value) {
    disciplineScientifiqueParent = value;
        ...
        public DisciplineScientifiqueConverter getDisciplineScientifiqueParentConverter(){
        return this.disciplineScientifiqueParentConverter;
        }
        public void setDisciplineScientifiqueParentConverter(DisciplineScientifiqueConverter disciplineScientifiqueParentConverter ){
