...
export class DisciplineScientifiqueService {
    ...
    public save(): Observable<DisciplineScientifiqueVo> {
        return this.http.post<DisciplineScientifiqueVo>(this.API, {
            ...this.selectedDisciplineScientifique,
            dateCreation: moment(this.selectedDisciplineScientifique.dateCreation).format('YYYY-MM-DD')
        });
    }
